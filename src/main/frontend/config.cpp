...
void Config::load(const std::string &filename)
{
    ...
    controls.padconfig[0]  = pt_config.get("controls.padconfig.up",    70);
    controls.padconfig[1]  = pt_config.get("controls.padconfig.down",  80);
    controls.padconfig[2]  = pt_config.get("controls.padconfig.left",  90);
    controls.padconfig[3]  = pt_config.get("controls.padconfig.right", 100);
    controls.padconfig[4]  = pt_config.get("controls.padconfig.acc",   0);
    controls.padconfig[5]  = pt_config.get("controls.padconfig.brake", 1);
    controls.padconfig[6]  = pt_config.get("controls.padconfig.gear1", 2);
    controls.padconfig[7]  = pt_config.get("controls.padconfig.gear2", 2);
    controls.padconfig[8]  = pt_config.get("controls.padconfig.start", 3);
    controls.padconfig[9]  = pt_config.get("controls.padconfig.coin",  4);
    controls.padconfig[10] = pt_config.get("controls.padconfig.menu",  5);
    controls.padconfig[11] = pt_config.get("controls.padconfig.view",  6);
    controls.analog        = pt_config.get("controls.analog.<xmlattr>.enabled", 0);
    controls.digital_pad   = pt_config.get("controls.digital_pad", 0);
...
bool Config::save(const std::string &filename)
{
    ...
    pt_config.put("controls.padconfig.up",    controls.padconfig[0]);
    pt_config.put("controls.padconfig.down",  controls.padconfig[1]);
    pt_config.put("controls.padconfig.left",  controls.padconfig[2]);
    pt_config.put("controls.padconfig.right", controls.padconfig[3]);
    pt_config.put("controls.padconfig.acc",   controls.padconfig[4]);
    pt_config.put("controls.padconfig.brake", controls.padconfig[5]);
    pt_config.put("controls.padconfig.gear1", controls.padconfig[6]);
    pt_config.put("controls.padconfig.gear2", controls.padconfig[7]);
    pt_config.put("controls.padconfig.start", controls.padconfig[8]);
    pt_config.put("controls.padconfig.coin",  controls.padconfig[9]);
    pt_config.put("controls.padconfig.menu",  controls.padconfig[10]);
    pt_config.put("controls.padconfig.view",  controls.padconfig[11]);
    pt_config.put("controls.analog.<xmlattr>.enabled", controls.analog);
    pt_config.put("controls.digital_pad",  controls.digital_pad);
