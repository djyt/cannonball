...
//
// Source: 0xBA68
void OPalette::setup_sky_cycle() // ok?
{
...
void OPalette::fade_sky_pal_entry(const uint16_t start_colour, const uint16_t end_colour, uint32_t addr) // ok?
{
    // START COLOUR
    // Extract bits 1-4
...
// - Uses the 0x1E palettes generated by setup_sky_cycle() (making 0x20 palettes total with the start and end palettes)
//
// Source: 0x8E20
void OPalette::cycle_sky_palette() // ok?
{
...
//
// Source: 0x9270
void OPalette::setup_fade_data() // ok?
{
    uint32_t addr = 0;
...
// Source: 0x9372
void OPalette::write_current_pal_to_ram() // ok?
{
...
// Source: 0x9434
void OPalette::write_next_pal_to_ram() // ok?
{
    uint32_t dst = 2;
    uint32_t stage_offset = oroad.stage_lookup_off;
...
void OPalette::repack_rgb(const uint32_t addr) // ok?
{
    pal_fade[addr + 1] = 0;
